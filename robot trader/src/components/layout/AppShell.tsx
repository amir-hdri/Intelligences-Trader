    ...
    <header className="sticky top-0 z-30 border-b bg-[#080B12]/95 backdrop-blur-xl border-white/[0.07]">
      ...
      <div className="hidden sm:flex h-[56px] items-center justify-between gap-3 px-3 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-blue-600 to-blue-600 grid place-items-center shadow-lg">
          ...
          <div>
            ...
            <div className="text-[11px] tracking-[0.06em] font-bold text-[#3B82F6] uppercase">
              IME • AI Terminal
            </div>
          </div>
          <span className={cn(
            "inline-flex items-center gap-1 ml-2 px-2 py-0.5 rounded-full border text-[11px] font-black tracking-wider",
          ...
          <div className="flex items-center gap-2 w-full">
            <div className="flex-1 flex items-center gap-2 h-9 px-3 rounded-xl bg-[#101620] border border-white/[0.07]">
              ...
              <input
                ...
                onFocus={onCmd}
              />
              <span className="hidden xl:inline-flex items-center gap-1 text-[11px] font-bold text-[#64748B] border border-white/10 rounded-lg px-1.5 py-0.5">
        ...
        <div className="flex items-center gap-2">
          <div className="hidden xl:flex items-center gap-1.5 text-[11px] font-mono mr-2">
            ...
            <span className="text-blue-300">AI {forecast ? 'ACTIVE' : 'IDLE'}</span>
          </div>
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 w-4 h-4 bg-blue-600 text-white text-[11px] font-black rounded-full grid place-items-center">
              3
            </span>
          </button>
      ...
      */}
      <div className="sm:hidden flex flex-col divide-y divide-white/[0.06] px-3 py-1 bg-[#080B12]">
        ...
        <div className="flex items-center justify-between py-1.5">
          ...
          <span className={cn(
            "inline-flex items-center gap-1 px-2 py-0.5 rounded-full border text-[11px] font-black tracking-wider",
            connectionState === 'CONNECTED' ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-amber-500/10 border-amber-500/20 text-amber-300",
          )}>
        ...
        <div className="flex items-center justify-between py-1.5 text-xs">
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn(
                "inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded text-[11px] font-black mono",
                priceChange >= 0
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] mono text-[#64748B]">
  ...
  >
    <nav aria-label="Primary" className="p-3 space-y-4">
      {NAV.map((g) => (
        <div key={g.label}>
          {!collapsed && (
            <div className="px-2 mb-1.5 text-[11px] tracking-[0.06em] font-black text-[#64748B] uppercase">
              {g.label}
            </div>
          )}
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ? "bg-blue-600/20 border-blue-500/30 text-white font-black"
                      : "border-transparent text-[#94A3B8] hover:bg-white/[0.04] hover:text-white font-medium"
                  )}
                >
                  <Icon className={cn("w-4 h-4 shrink-0", active ? "text-blue-400" : "text-[#64748B]")} />
    ...
    <div className="mt-auto p-3 border-t border-white/[0.06]">
      ...
      >
        ...
        {!collapsed && (
          <div className="text-[11px] text-[#64748B] mt-1 mono">
      ...
      >
        ...
        {NAV.map((g) => (
          <div key={g.label} className="space-y-1.5">
            <div className="text-[11px] tracking-wider font-black text-[#64748B] uppercase">
              {g.label}
            </div>
              ...
              {g.items.map((it) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeTab === it.id ? "bg-blue-600 text-white" : "text-[#94A3B8] hover:text-white"
                  )}
                >
      ...
      return (
        <button
          ...
          className={cn(
            ...
            active ? "text-blue-400 font-black scale-105" : "text-[#64748B]"
          )}
        >
